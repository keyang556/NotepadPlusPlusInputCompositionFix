...
addon_info = AddonInfo(
	...
	addon_name="notepadPlusPlusImeFix",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("Notepad++ IME composition fix"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	addon_description=_("""Restores NVDA caret reporting for uncommitted IME composition text in 64-bit Notepad++ 8.3 and later."""),
	# version
	addon_version="2.0.0",
	# Brief changelog for this version
	# Translators: what's new content for the add-on version to be shown in the add-on store
	addon_changelog=_("""Adds Traditional Chinese documentation and add-on metadata translations."""),
	# Author(s)
	addon_author="張可揚<lindsay714322@gmail.com>",
...
pythonSources: list[str] = ["addon/appModules/notepadPlusPlus.py"]
